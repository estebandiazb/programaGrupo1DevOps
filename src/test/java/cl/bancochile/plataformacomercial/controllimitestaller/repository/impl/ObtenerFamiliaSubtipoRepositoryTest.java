...
public class ObtenerFamiliaSubtipoRepositoryTest {
    @Autowired
    ...
    public void ObtenerItemVariablePorIdRepositoryTest() throws Exception {
        ...
        ReflectionUtil.setProperty(obtenerFamiliaSubtipoRepository, "simpleJdbcCall", simpleJdbcCall);
        obtenerFamiliaSubtipoRepository.ejecutar();
    }
