...
public class ObtenerTipoLimitePorIdFamiliaRepositoryTest {
    @Autowired
    ...
    public void ObtenerItemVariablePorIdRepositoryTest() throws Exception {
        ...
        ReflectionUtil.setProperty(obtenerTipoLimitePorIdFamiliaRepository, "simpleJdbcCall", simpleJdbcCall);
        obtenerTipoLimitePorIdFamiliaRepository.ejecutar(1L);
    }
