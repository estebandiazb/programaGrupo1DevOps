...
public class ObtenerItemVariablePorIdRepositoryTest {
    @Autowired
    ...
    public void ObtenerItemVariablePorIdRepositoryTest() throws Exception {
        ...
        ReflectionUtil.setProperty(obtenerItemVariablePorIdRepository, "simpleJdbcCall", simpleJdbcCall);
        obtenerItemVariablePorIdRepository.ejecutar(1L);
    }
